...
public partial class SimpleGrammarBaseListener : ISimpleGrammarListener {
	...
	/// <summary>
	/// Enter a parse tree produced by <see cref="SimpleGrammarParser.read"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterRead([NotNull] SimpleGrammarParser.ReadContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="SimpleGrammarParser.read"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitRead([NotNull] SimpleGrammarParser.ReadContext context) { }
	/// <summary>
